...
int main(int argc, char **argv) {
    ...
    //ImageProcessor::Options image_processor_option = {.name = std::string("yolovfastest"),.alias = "DetectionWindow"};

    ImageProcessor::Options image_processor_option = {.name = std::string("car"), .alias = "DetectionWindow"};
